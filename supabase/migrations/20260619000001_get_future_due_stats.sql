-- Migration: 20260619000001_get_future_due_stats.sql
-- Description: Adds a function to calculate future due card statistics grouped by day buckets, adjusted for the user's local timezone.
